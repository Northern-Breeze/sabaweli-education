...
export default function Payfast(props: { email: string, loading: boolean }): JSX.Element {
  ...
  return (
    <div>
      <form action={config["PAYFAST_URL"]} method="post">
        ...
        <input type="hidden" name="email_address" value="samuelmthwa79@gmail.com" />
        <input
          type="hidden"
          name="return_url"
        ...
        <input type="hidden" name="confirmation_address" value="samuelmthwa79@gmail.com" />
        <input type="hidden" name="signature" value={signature} />
        <button type="submit" className="button primary" disabled={!signature}>
          Pay Now
        </button>
      </form>
    </div>
